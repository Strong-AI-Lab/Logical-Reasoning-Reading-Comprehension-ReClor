...
- `train.json` put whole training set together from the whole `Depth=2,3,4,5`.
- `val.json` put whole validation set together from the whole `Depth=2,3,4,5`.
- `test.json` put whole test set together from the whole `Depth=2,3,4,5`.
