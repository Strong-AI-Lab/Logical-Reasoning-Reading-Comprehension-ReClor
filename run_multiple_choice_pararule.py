...
""" Finetuning the library models for multiple choice (Bert, Roberta, XLNet, AutoModel)."""
...
# ALL_MODELS = sum(
#     (tuple(conf.pretrained_config_archive_map.keys()) for conf in (BertConfig, XLNetConfig, RobertaConfig, AutoConfig)), ()
# )
...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        default="Checkpoints/pararule/roberta-large-mnli-pararule",
        type=str,
        required=False,
    ...
    args.task_name = "pararule"
    args.model_type = "roberta"
    args.data_dir = "PARARULE_Plus"
    args.model_name_or_path = "roberta-large-mnli"
